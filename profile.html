            ...
            <div class="row g-4">
                ...
                <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                    <div class="card post-card">
                        <div class="image-wrapper">
                            <a href="/post1.html">
                                <img src="/static/img/sitka.jpg" class="card-img-top" alt="Post 1">
                                <div class="overlay">
                ...
                <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                    <div class="card post-card">
                        <div class="image-wrapper">
                            <a href="/post2.html">
                                <img src="/static/img/doshovic.jpg" class="card-img-top" alt="Post 2">
                                <div class="overlay">
                ...
                <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                    <div class="card post-card">
                        <div class="image-wrapper">
                            <a href="/post3.html">
                                <img src="/static/img/not_img.png" class="card-img-top" alt="Post 3">
                                <div class="overlay">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-4 mb-4">
                    ...
                    <ul class="list-unstyled footer-links">
                        ...
                        <li><a href="/catalog.html">Публікації</a></li>
