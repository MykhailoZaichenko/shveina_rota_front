            ...
            <div class="col-md-9 mt-4 mt-md-0">
                ...
                <div class="row g-4">
                    <div class="col-sm-6 col-md-4">
                        <a href="/posts-id.html" class="post-card">
                            <div class="image-wrapper shadow-sm">
                                <img src="/static/img/sitka.jpg" alt="Admin Post 2">
                                <div class="overlay">Рекомендовано</div>
                            </div>
                        </a>
                    </div>
                    <div class="col-sm-6 col-md-4">
                ...
                <div class="row g-4">
                    <div class="col-sm-6 col-md-4">
                        <a href="/posts-id.html" class="post-card">
                            <div class="image-wrapper shadow-sm">
                                <img src="/static/img/sitka.jpg" alt="User Post 1">
                                <div class="overlay">Пост користувача</div>
                            </div>
                        </a>
                    </div>
                    <div class="col-sm-6 col-md-4">
                        <a href="/posts-id.html" class="post-card">
                            <div class="image-wrapper shadow-sm">
                                <img src="/static/img/sitka.jpg" alt="User Post 2">
                                <div class="overlay">Пост користувача</div>
                            </div>
                        </a>
                    </div>
